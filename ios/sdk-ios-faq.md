...
## How do I fix cocoapods could not find compatible versions for pod?

If when you run the command `pod install`, you are getting this error: CocoaPods could not find compatible versions for pod "DatadogSDKObjC
